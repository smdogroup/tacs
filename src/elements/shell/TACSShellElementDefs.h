...
typedef TACSShellElement<TACSQuadCubicQuadrature, TACSShellTriLinearBasis,
                         TACSLinearizedRotation, TACSShellInplaneNonlinearModel> TACSTri3NonlinearShell;

/*
  Thermal shell elements with appropriate quadrature schemes
*/
typedef TACSThermalShellElement<TACSQuadLinearQuadrature, TACSShellQuadBasis<2>,
                                TACSLinearizedRotation, TACSShellNonlinearModel> TACSQuad4NonlinearThermalShell;

typedef TACSThermalShellElement<TACSQuadQuadraticQuadrature, TACSShellQuadBasis<3>,
                                TACSLinearizedRotation, TACSShellNonlinearModel> TACSQuad9NonlinearThermalShell;

typedef TACSThermalShellElement<TACSQuadCubicQuadrature, TACSShellQuadBasis<4>,
                                TACSLinearizedRotation, TACSShellNonlinearModel> TACSQuad16NonlinearThermalShell;

typedef TACSThermalShellElement<TACSTriLinearQuadrature, TACSShellTriLinearBasis,
                                TACSLinearizedRotation, TACSShellInplaneNonlinearModel> TACSTri3NonlinearThermalShell;
