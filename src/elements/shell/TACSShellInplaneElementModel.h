...
class TACSShellInplaneNonlinearModel {
  ...
  */
  static void evalStrain( const TacsScalar u0x[],
    ...
    e[2] = u0x[1] + u0x[3] + (u0x[0]*u0x[1] + u0x[3]*u0x[4] + u0x[6]*u0x[7]);
  ...
  */
  static void evalStrainSens( const TacsScalar scale,
    ...
    du0x[0] = scale*(dfde[0]*(u0x[0] + 1.0) + dfde[2]*u0x[1] + dfde[3]*u1x[0] + dfde[5]*u1x[1]);
    du0x[1] = scale*(dfde[1]*u0x[1] + dfde[2]*(u0x[0] + 1.0) + dfde[4]*u1x[1] + dfde[5]*u1x[0]);
    du0x[2] = 0.0;
    du0x[3] = scale*(dfde[0]*u0x[3] + dfde[2]*(u0x[4] + 1.0) + dfde[3]*u1x[3] + dfde[5]*u1x[4]);
    du0x[4] = scale*(dfde[1]*(u0x[4] + 1.0) + dfde[2]*u0x[3] + dfde[4]*u1x[4] + dfde[5]*u1x[3]);
    du0x[5] = 0.0;
    du0x[6] = scale*(dfde[0]*u0x[6] + dfde[2]*u0x[7] + dfde[3]*u1x[6] + dfde[5]*u1x[7]);
    du0x[7] = scale*(dfde[1]*u0x[7] + dfde[2]*u0x[6] + dfde[4]*u1x[7] + dfde[5]*u1x[6]);
    du0x[8] = 0.0;
  ...
  static void evalStrainDeriv( const TacsScalar u0x[],
    ...
    ed[2] = u0xd[1] + u0xd[3] + (u0xd[0]*u0x[1] + u0xd[3]*u0x[4] + u0xd[6]*u0x[7] +
  ...
  static void evalStrainHessian( const TacsScalar scale,
    ...
    TacsScalar Du0x[36];
    Du0x[0] = A[0]*(u0x[0] + 1.0) + A[2]*u0x[1] + B[0]*u1x[0] + B[2]*u1x[1];
    Du0x[1] = A[1]*(u0x[0] + 1.0) + A[4]*u0x[1] + B[1]*u1x[0] + B[4]*u1x[1];
    Du0x[2] = A[2]*(u0x[0] + 1.0) + A[5]*u0x[1] + B[2]*u1x[0] + B[5]*u1x[1];
    Du0x[3] = B[0]*(u0x[0] + 1.0) + B[2]*u0x[1] + D[0]*u1x[0] + D[2]*u1x[1];
    Du0x[4] = B[1]*(u0x[0] + 1.0) + B[4]*u0x[1] + D[1]*u1x[0] + D[4]*u1x[1];
    Du0x[5] = B[2]*(u0x[0] + 1.0) + B[5]*u0x[1] + D[2]*u1x[0] + D[5]*u1x[1];
    Du0x[6] = A[1]*u0x[1] + A[2]*(u0x[0] + 1.0) + B[1]*u1x[1] + B[2]*u1x[0];
    Du0x[7] = A[3]*u0x[1] + A[4]*(u0x[0] + 1.0) + B[3]*u1x[1] + B[4]*u1x[0];
    Du0x[8] = A[4]*u0x[1] + A[5]*(u0x[0] + 1.0) + B[4]*u1x[1] + B[5]*u1x[0];
    Du0x[9] = B[1]*u0x[1] + B[2]*(u0x[0] + 1.0) + D[1]*u1x[1] + D[2]*u1x[0];
    Du0x[10] = B[3]*u0x[1] + B[4]*(u0x[0] + 1.0) + D[3]*u1x[1] + D[4]*u1x[0];
    Du0x[11] = B[4]*u0x[1] + B[5]*(u0x[0] + 1.0) + D[4]*u1x[1] + D[5]*u1x[0];
    Du0x[12] = A[0]*u0x[3] + A[2]*(u0x[4] + 1.0) + B[0]*u1x[3] + B[2]*u1x[4];
    Du0x[13] = A[1]*u0x[3] + A[4]*(u0x[4] + 1.0) + B[1]*u1x[3] + B[4]*u1x[4];
    Du0x[14] = A[2]*u0x[3] + A[5]*(u0x[4] + 1.0) + B[2]*u1x[3] + B[5]*u1x[4];
    Du0x[15] = B[0]*u0x[3] + B[2]*(u0x[4] + 1.0) + D[0]*u1x[3] + D[2]*u1x[4];
    Du0x[16] = B[1]*u0x[3] + B[4]*(u0x[4] + 1.0) + D[1]*u1x[3] + D[4]*u1x[4];
    Du0x[17] = B[2]*u0x[3] + B[5]*(u0x[4] + 1.0) + D[2]*u1x[3] + D[5]*u1x[4];
    Du0x[18] = A[1]*(u0x[4] + 1.0) + A[2]*u0x[3] + B[1]*u1x[4] + B[2]*u1x[3];
    Du0x[19] = A[3]*(u0x[4] + 1.0) + A[4]*u0x[3] + B[3]*u1x[4] + B[4]*u1x[3];
    Du0x[20] = A[4]*(u0x[4] + 1.0) + A[5]*u0x[3] + B[4]*u1x[4] + B[5]*u1x[3];
    Du0x[21] = B[1]*(u0x[4] + 1.0) + B[2]*u0x[3] + D[1]*u1x[4] + D[2]*u1x[3];
    Du0x[22] = B[3]*(u0x[4] + 1.0) + B[4]*u0x[3] + D[3]*u1x[4] + D[4]*u1x[3];
    Du0x[23] = B[4]*(u0x[4] + 1.0) + B[5]*u0x[3] + D[4]*u1x[4] + D[5]*u1x[3];
    ...
    d2u0x[0] = scale*(Du0x[0]*(u0x[0] + 1.0) + Du0x[2]*u0x[1] + Du0x[3]*u1x[0] + Du0x[5]*u1x[1] + s[0]);
    d2u0x[1] = scale*(Du0x[1]*u0x[1] + Du0x[2]*(u0x[0] + 1.0) + Du0x[4]*u1x[1] + Du0x[5]*u1x[0] + s[2]);
    d2u0x[2] = 0.0;
    d2u0x[3] = scale*(Du0x[0]*u0x[3] + Du0x[2]*(u0x[4] + 1.0) + Du0x[3]*u1x[3] + Du0x[5]*u1x[4]);
    d2u0x[4] = scale*(Du0x[1]*(u0x[4] + 1.0) + Du0x[2]*u0x[3] + Du0x[4]*u1x[4] + Du0x[5]*u1x[3]);
    d2u0x[5] = 0.0;
    d2u0x[6] = scale*(Du0x[0]*u0x[6] + Du0x[2]*u0x[7] + Du0x[3]*u1x[6] + Du0x[5]*u1x[7]);
    d2u0x[7] = scale*(Du0x[1]*u0x[7] + Du0x[2]*u0x[6] + Du0x[4]*u1x[7] + Du0x[5]*u1x[6]);
    d2u0x[8] = 0.0;

    d2u0x[9] = scale*(Du0x[11]*u1x[1] + Du0x[6]*(u0x[0] + 1.0) + Du0x[8]*u0x[1] + Du0x[9]*u1x[0] + s[2]);
    d2u0x[10] = scale*(Du0x[10]*u1x[1] + Du0x[11]*u1x[0] + Du0x[7]*u0x[1] + Du0x[8]*(u0x[0] + 1.0) + s[1]);
    d2u0x[11] = 0.0;
    d2u0x[12] = scale*(Du0x[11]*u1x[4] + Du0x[6]*u0x[3] + Du0x[8]*(u0x[4] + 1.0) + Du0x[9]*u1x[3]);
    d2u0x[13] = scale*(Du0x[10]*u1x[4] + Du0x[11]*u1x[3] + Du0x[7]*(u0x[4] + 1.0) + Du0x[8]*u0x[3]);
    d2u0x[14] = 0.0;
    d2u0x[15] = scale*(Du0x[11]*u1x[7] + Du0x[6]*u0x[6] + Du0x[8]*u0x[7] + Du0x[9]*u1x[6]);
    d2u0x[16] = scale*(Du0x[10]*u1x[7] + Du0x[11]*u1x[6] + Du0x[7]*u0x[7] + Du0x[8]*u0x[6]);
    d2u0x[17] = 0.0;
    ...
    d2u0x[27] = scale*(Du0x[12]*(u0x[0] + 1.0) + Du0x[14]*u0x[1] + Du0x[15]*u1x[0] + Du0x[17]*u1x[1]);
    d2u0x[28] = scale*(Du0x[13]*u0x[1] + Du0x[14]*(u0x[0] + 1.0) + Du0x[16]*u1x[1] + Du0x[17]*u1x[0]);
    d2u0x[29] = 0.0;
    d2u0x[30] = scale*(Du0x[12]*u0x[3] + Du0x[14]*(u0x[4] + 1.0) + Du0x[15]*u1x[3] + Du0x[17]*u1x[4] + s[0]);
    d2u0x[31] = scale*(Du0x[13]*(u0x[4] + 1.0) + Du0x[14]*u0x[3] + Du0x[16]*u1x[4] + Du0x[17]*u1x[3] + s[2]);
    d2u0x[32] = 0.0;
    d2u0x[33] = scale*(Du0x[12]*u0x[6] + Du0x[14]*u0x[7] + Du0x[15]*u1x[6] + Du0x[17]*u1x[7]);
    d2u0x[34] = scale*(Du0x[13]*u0x[7] + Du0x[14]*u0x[6] + Du0x[16]*u1x[7] + Du0x[17]*u1x[6]);
    d2u0x[35] = 0.0;

    d2u0x[36] = scale*(Du0x[18]*(u0x[0] + 1.0) + Du0x[20]*u0x[1] + Du0x[21]*u1x[0] + Du0x[23]*u1x[1]);
    d2u0x[37] = scale*(Du0x[19]*u0x[1] + Du0x[20]*(u0x[0] + 1.0) + Du0x[22]*u1x[1] + Du0x[23]*u1x[0]);
    d2u0x[38] = 0.0;
    d2u0x[39] = scale*(Du0x[18]*u0x[3] + Du0x[20]*(u0x[4] + 1.0) + Du0x[21]*u1x[3] + Du0x[23]*u1x[4] + s[2]);
    d2u0x[40] = scale*(Du0x[19]*(u0x[4] + 1.0) + Du0x[20]*u0x[3] + Du0x[22]*u1x[4] + Du0x[23]*u1x[3] + s[1]);
    d2u0x[41] = 0.0;
    d2u0x[42] = scale*(Du0x[18]*u0x[6] + Du0x[20]*u0x[7] + Du0x[21]*u1x[6] + Du0x[23]*u1x[7]);
    d2u0x[43] = scale*(Du0x[19]*u0x[7] + Du0x[20]*u0x[6] + Du0x[22]*u1x[7] + Du0x[23]*u1x[6]);
    d2u0x[44] = 0.0;
    ...
    d2u0x[54] = scale*(Du0x[24]*(u0x[0] + 1.0) + Du0x[26]*u0x[1] + Du0x[27]*u1x[0] + Du0x[29]*u1x[1]);
    d2u0x[55] = scale*(Du0x[25]*u0x[1] + Du0x[26]*(u0x[0] + 1.0) + Du0x[28]*u1x[1] + Du0x[29]*u1x[0]);
    d2u0x[56] = 0.0;
    d2u0x[57] = scale*(Du0x[24]*u0x[3] + Du0x[26]*(u0x[4] + 1.0) + Du0x[27]*u1x[3] + Du0x[29]*u1x[4]);
    d2u0x[58] = scale*(Du0x[25]*(u0x[4] + 1.0) + Du0x[26]*u0x[3] + Du0x[28]*u1x[4] + Du0x[29]*u1x[3]);
    d2u0x[59] = 0.0;
    d2u0x[60] = scale*(Du0x[24]*u0x[6] + Du0x[26]*u0x[7] + Du0x[27]*u1x[6] + Du0x[29]*u1x[7] + s[0]);
    d2u0x[61] = scale*(Du0x[25]*u0x[7] + Du0x[26]*u0x[6] + Du0x[28]*u1x[7] + Du0x[29]*u1x[6] + s[2]);
    d2u0x[62] = 0.0;

    d2u0x[63] = scale*(Du0x[30]*(u0x[0] + 1.0) + Du0x[32]*u0x[1] + Du0x[33]*u1x[0] + Du0x[35]*u1x[1]);
    d2u0x[64] = scale*(Du0x[31]*u0x[1] + Du0x[32]*(u0x[0] + 1.0) + Du0x[34]*u1x[1] + Du0x[35]*u1x[0]);
    d2u0x[65] = 0.0;
    d2u0x[66] = scale*(Du0x[30]*u0x[3] + Du0x[32]*(u0x[4] + 1.0) + Du0x[33]*u1x[3] + Du0x[35]*u1x[4]);
    d2u0x[67] = scale*(Du0x[31]*(u0x[4] + 1.0) + Du0x[32]*u0x[3] + Du0x[34]*u1x[4] + Du0x[35]*u1x[3]);
    d2u0x[68] = 0.0;
    d2u0x[69] = scale*(Du0x[30]*u0x[6] + Du0x[32]*u0x[7] + Du0x[33]*u1x[6] + Du0x[35]*u1x[7] + s[2]);
    d2u0x[70] = scale*(Du0x[31]*u0x[7] + Du0x[32]*u0x[6] + Du0x[34]*u1x[7] + Du0x[35]*u1x[6] + s[1]);
    d2u0x[71] = 0.0;
