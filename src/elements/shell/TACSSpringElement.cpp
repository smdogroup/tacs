...
*/
TACSSpringElement::TACSSpringElement( TACSSpringTransform * _transform,
...
*/
const char * TACSSpringElement::getObjectName(){
  return elemName;
}
...
*/
int TACSSpringElement::getVarsPerNode(){
  return NUM_DISPS;
}
int TACSSpringElement::getNumNodes(){
  return NUM_NODES;
}
...
*/
void TACSSpringElement::transformResLocalToGlobalSens( const TacsScalar t[],
...
void TACSSpringElement::computeEnergies( int elemIndex,
                                         double time,
...
void TACSSpringElement::addJacobian( int elemIndex, double time,
  ...
  for ( int row = 0; row < NUM_VARIABLES; row++ ){
    ...
    for ( int col = 0; col < NUM_VARIABLES; col++ ){
      mat[col + row*NUM_VARIABLES] += alpha * elemMat[col + row*NUM_VARIABLES];
    }
  }
...
*/
void TACSSpringElement::addAdjResXptProduct( int elemIndex, double time,
                                             TacsScalar scale,
...
int TACSSpringElement::evalPointQuantity( int elemIndex, int quantityType,
                                          double time,
                                          int n, double pt[],
                                          const TacsScalar Xpts[],
                                          const TacsScalar vars[],
