...
int TACSQuadraticHexaBernsteinBasis::getNumNodes(){
  return 27;
}

int TACSQuadraticHexaBernsteinBasis::getNumParameters(){
  return 3;
}

int TACSQuadraticHexaBernsteinBasis::getNumQuadraturePoints(){
  return 27;
}
...
double TACSQuadraticHexaBernsteinBasis::getQuadraturePoint( int n,
                                                            double pt[] ){
...
int TACSQuadraticHexaBernsteinBasis::getNumElementFaces(){
  return 6;
}
...
double TACSQuadraticHexaBernsteinBasis::getFaceQuadraturePoint( int face,
                                                                int n,
                                                                double pt[],
                                                                double t[] ){
  if (face/2 == 0){
...
int TACSCubicHexaBernsteinBasis::getNumNodes(){
  return 64;
}

int TACSCubicHexaBernsteinBasis::getNumParameters(){
  return 3;
}

int TACSCubicHexaBernsteinBasis::getNumQuadraturePoints(){
  return 64;
}
...
double TACSCubicHexaBernsteinBasis::getQuadraturePoint( int n,
                                                        double pt[] ){
...
int TACSCubicHexaBernsteinBasis::getNumElementFaces(){
  return 4;
}
...
double TACSCubicHexaBernsteinBasis::getFaceQuadraturePoint( int face,
                                                            int n,
                                                            double pt[],
                                                            double t[] ){
  if (face/2 == 0){
...
void TACSCubicHexaBernsteinBasis::computeBasis( const double pt[],
                                                double N[] ){
