...
int TacsGetNumVisNodes( ElementLayout ltype ){
  ...
  case TACS_LINE_ELEMENT: return 2;
  case TACS_LINE_QUADRATIC_ELEMENT: return 3;
  case TACS_LINE_CUBIC_ELEMENT: return 4;

  case TACS_TRI_ELEMENT: return 3;
  case TACS_TRI_QUADRATIC_ELEMENT: return 6;
  case TACS_TRI_CUBIC_ELEMENT: return 10;

  case TACS_QUAD_ELEMENT: return 4;
  case TACS_QUAD_QUADRATIC_ELEMENT: return 9;
  case TACS_QUAD_CUBIC_ELEMENT: return 16;
  case TACS_QUAD_QUARTIC_ELEMENT: return 25;
  case TACS_QUAD_QUINTIC_ELEMENT: return 36;

  case TACS_TETRA_ELEMENT: return 4;
  case TACS_TETRA_QUADRATIC_ELEMENT: return 10;
  case TACS_TETRA_CUBIC_ELEMENT: return 17;

  case TACS_HEXA_ELEMENT: return 8;
  case TACS_HEXA_QUADRATIC_ELEMENT: return 27;
  case TACS_HEXA_CUBIC_ELEMENT: return 64;
  case TACS_HEXA_QUARTIC_ELEMENT: return 125;
