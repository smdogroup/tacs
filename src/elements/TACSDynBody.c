...
*/
TACSDynVector::TACSDynVector( const TacsScalar _x[] ){
  x[0] = _x[0];
  x[1] = _x[1];
  x[2] = _x[2];
  xDV[0] = xDV[1] = xDV[2] = -1;
...
*/
void TACSDynVector::getVector( const TacsScalar **_x ){ 
  *_x = x;
}
...
*/
void TACSDynVector::setDesignVars( const TacsScalar *dvs, int numDVs ){
...
*/
void TACSDynVector::getDesignVars( TacsScalar *dvs, int numDVs ){
...
*/
TACSDynFrame::TACSDynFrame( TACSDynVector *_r0, 
			    TACSDynVector *_r1,
			    TACSDynVector *_r2 ){
  r0 = _r0;
  r1 = _r1;
...
*/
void TACSDynFrame::getRotation( const TacsScalar **_C ){
  *_C = C;
}
...
*/
void TACSDynFrame::setDesignVars( const TacsScalar *dvs, 
				  int numDVs ){
...
/*
  ...
  dvs:     the design variable values
*/
void TACSDynFrame::getDesignVars( TacsScalar *dvs, int numDVs ){
...
*/
void TACSDynFrame::addRotationAdjResProduct( TacsScalar fdvSens[],
					     int numDVs,
...
*/
void TACSDynFrame::testRotation( int numDVs, double dh ){
  ...
  writeErrorComponents(stdout, "TACSDynFrame", dfdx, fd, 9);
...
*/
TACSDynBody::TACSDynBody( enum RotationParam _rot_param,
			  ...
			  TACSDynVector *gvec ){
  // Set the type of parametrization
  rot_param = _rot_param;

  // Set the number of kinemaic variables
  nkin = 6;
...
/*
  Set the design variable numbers associated with the inertial properties of
  the body
...
*/
void TACSDynBody::setDesignVarNums( int _massDV, const int _cDV[], 
				    const int _JDV[] ){
  massDV = _massDV;
  if (_cDV){
    cDV[0] = _cDV[0];
...
*/
void TACSDynBody::setDesignVars( const TacsScalar dvs[], int numDVs ){
...
*/
void TACSDynBody::getDesignVars( TacsScalar dvs[], int numDVs ){
...
*/
void TACSDynBody::setVariables( const TacsScalar qkin[],
...
*/
void TACSDynBody::getVariables( const TacsScalar *_r0[], 
...
*/
void TACSDynBody::getInitVariables( TacsScalar qkin[],
				    TacsScalar qdyn[] ){
...
*/
void TACSDynBody::getInitVariables( TACSDynFrame **_CRef,
				    TACSDynVector **_rInit, 
				    TACSDynVector **_vInit,
				    TACSDynVector **_omegaInit ){
  if (_CRef){ *_CRef = CRef; }
...
*/
void TACSDynBody::getRotation( const TacsScalar *_C[] ){
  if (_C){ *_C = C; }
}
...
*/
void TACSDynBody::getRotationDeriv( const TacsScalar *_C[],
...
*/
void TACSDynBody::addRotationAdjResProduct( TacsScalar fdvSens[], 
					    int numDVs,
					    const TacsScalar psi[],
					    const TacsScalar phi[] ){
  TacsScalar t[3];
...
*/
void TACSDynBody::testRotation( TacsScalar qkin[], double dh ){
...
*/
void TACSDynBody::getInertial( TacsScalar *_mass, 
			       const TacsScalar *_c[], 
			       const TacsScalar *_J[] ){
  if (_mass){ *_mass = mass; }
  if (_c){ *_c = c; }
...
*/
void TACSDynBody::addInertialAdjResProduct( TacsScalar fdvSens[],
					    int numDVs, 
					    TacsScalar dmdx, 
...
*/
void TACSDynBody::getEnergies( TacsScalar *Te,
			       TacsScalar *Pe ){
...
/*
  ...
  res:   the residual
*/
void TACSDynBody::getResidual( TacsScalar rkin[], 
			       TacsScalar rdyn[],
...
*/
void TACSDynBody::getJacobian( TacsScalar D11[],
			       TacsScalar D12[],
			       TacsScalar D21[],
			       TacsScalar D22[],
			       double alpha,
...
*/
void TACSDynBody::addAdjResProduct( TacsScalar fdvSens[], 
				    int numDVs,
				    const TacsScalar qkinDot[],
				    const TacsScalar qdynDot[],
...
*/
void TACSDynBody::addAdjInitVariableProduct( TacsScalar fdvSens[], 
					     int numDVs,
					     const TacsScalar kinAdj[], 
					     const TacsScalar dynAdj[] ){
...
*/
void TACSDynBody::testAdjResProduct( int numDVs, double dh ){
  // Allocate design variable arrays
  TacsScalar *x = new TacsScalar[ numDVs ];
  TacsScalar *fdvSens = new TacsScalar[ numDVs ];
...
*/
void TACSDynBody::testJacobian( double alpha, double beta, 
...
*/
TACSDynSphericalJoint::TACSDynSphericalJoint( TACSDynBody *_bodyA,
					      TACSDynBody *_bodyB,
...
void TACSDynSphericalJoint::updatePoints(){
  ...
  TACSDynFrame *FA0, *FB0;
  TACSDynVector *rA0vec, *rB0vec;
...
/*
  Retrieve the bodies associated with this kinematic constraint
*/
void TACSDynSphericalJoint::getBodies( TACSDynBody **_bodyA,
				       TACSDynBody **_bodyB ){
  *_bodyA = bodyA;
  *_bodyB = bodyB;
}
...
*/
TACSDynRevoluteJoint::TACSDynRevoluteJoint( TACSDynBody *_bodyA,
					    TACSDynBody *_bodyB,
					    TACSDynVector *_point,
					    TACSDynVector *_rev ){
  // Copy over the pointer to the first body object
...
/*
  Retrieve the bodies associated with this kinematic constraint
*/
void TACSDynRevoluteJoint::getBodies( TACSDynBody **_bodyA,
				      TACSDynBody **_bodyB ){
  *_bodyA = bodyA;
  *_bodyB = bodyB;
}
