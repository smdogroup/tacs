...
const double TacsGaussQuadPts5[] = { -0.906179845938664, -0.538469310105683,
                                     0.0,
...
const double TacsGaussQuadPts6[] = { -0.9324695142031520278123016,
                                     -0.6612093864662645136613996,
                                     -0.2386191860831969086305017,
                                     0.2386191860831969086305017,
                                     0.6612093864662645136613996,
                                     0.9324695142031520278123016  };
const double TacsGaussQuadWts6[] = {  0.1713244923791703450402961,
...
const double TacsGaussQuadPts7[] = { -0.9491079123427585245261897,
...
const double TacsGaussQuadWts7[] = { 0.1294849661688696932706114,
...
const double TacsGaussQuadPts8[] = { -0.9602898564975362316835609,
...
const double TacsGaussQuadWts8[] = { 0.1012285362903762591525314,
...
const double TacsGaussLobattoWts4[] = { 1.0/6.0, 5.0/6.0, 5.0/6.0, 1.0/6.0 };
...
const double TacsGaussLobattoPts6[] = { -1.0, -0.76505532392946474,
                                        -0.2852315164806451,
                                        0.2852315164806451,
                                        0.76505532392946474, 1.0 };
const double TacsGaussLobattoWts6[] = { 1.0/15.0,
                                        0.378474956297847,
                                        0.55485837703548635,
                                        0.55485837703548635,
                                        0.378474956297847,
