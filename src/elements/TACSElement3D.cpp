...
TACSElement* TACSElement3D::createElementTraction(TacsScalar t[], int faceIndex){
...
void TACSElement3D::addAdjResXptProduct( int elemIndex,
  ...
  for ( int n = 0; n < nquad; n++ ){
    ...
    model->evalWeakAdjXptSensProduct(elemIndex, time, n, pt, X, Xd,
...
void TACSElement3D::getMatVecDataSizes( ElementMatrixType matType,
                                        int elemIndex,
...
void TACSElement3D::getMatVecProductData( ElementMatrixType matType,
...
void TACSElement3D::addMatVecProduct( ElementMatrixType matType,
                                      int elemIndex,
