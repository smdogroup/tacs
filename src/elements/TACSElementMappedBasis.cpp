...
TacsScalar TACSElementMappedBasis::computeMappedFaceNormal( const int num_params,
                                                            const int num_nodes,
                                                            const double N[],
                                                            const double Nxi[],
                                                            const TacsScalar Xpts[],
...
void TACSElementMappedBasis::addFaceNormalXptSens( int face, int n,
                                                   const TacsScalar A,
                                                   const TacsScalar Xd[],
...
TacsScalar TACSElementMappedBasis::computeMappedJacobianTransform( const int num_params,
                                                                   const int num_nodes,
                                                                   const double Nxi[],
                                                                   const TacsScalar Xpts[],
                                                                   TacsScalar Xd[],
