...
#ifndef TACS_MITC_PLATE_MODEL_H
#define TACS_MITC_PLATE_MODEL_H

#include "TACSShellConstitutive.h"
#include "TACSMITCModel.h"

class TACSMITCPlateModel : public TACSMITCModel {
 public:
  TACSMITCPlateModel( TACSShellConstitutive *_con );
  ~TACSMITCPlateModel();
