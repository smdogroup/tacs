...
TACSConvectiveTraction3D::TACSConvectiveTraction3D( int _varsPerNode,
                                                    int _faceIndex,
                                                    int _fieldIndex,
                                                    TacsScalar _alpha,
                                                    TacsScalar _refValue,
...
int TACSConvectiveTraction3D::getVarsPerNode(){
  return varsPerNode;
}

int TACSConvectiveTraction3D::getNumNodes(){
...
TACSElementBasis* TACSConvectiveTraction3D::getElementBasis(){
  return basis;
}
...
double TACSConvectiveTraction3D::getFaceQuadraturePoint( int face, int n, double pt[],
                                                         double tangent[] ){
...
*/
void TACSConvectiveTraction3D::addResidual( int elemIndex,
                                            double time,
...
*/
void TACSConvectiveTraction3D::addJacobian( int elemIndex,
                                            double time,
                                            TacsScalar alpha,
                                            TacsScalar beta,
                                            TacsScalar gamma,
...
void TACSConvectiveTraction3D::addAdjResProduct( int elemIndex,
                                                 double time,
                                                 TacsScalar scale,
...
void TACSConvectiveTraction3D::addAdjResXptProduct( int elemIndex,
                                                    double time,
                                                    TacsScalar scale,
                                                    const TacsScalar psi[],
                                                    const TacsScalar Xpts[],
