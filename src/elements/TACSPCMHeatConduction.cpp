...
TACSPCMHeatConduction2D::TACSPCMHeatConduction2D( TACSPhaseChangeMaterialConstitutive *_stiff ){
  stiff = _stiff;
  stiff->incref();
}
...
int TACSPCMHeatConduction2D::getNumParameters(){
  return 2;
}

int TACSPCMHeatConduction2D::getVarsPerNode(){
  return 1;
}
