...
/*
  ...
  num_components: the number of gradient components to compute
*/
void linear_bmat_sens( TacsScalar B[], TacsScalar dB[],
                       TacsScalar rotz[], TacsScalar drotz[],
                       int num_points,
                       const double N[], const double Na[], const double Nb[],
                       const TacsScalar t[], const TacsScalar dt[],
...
void add_tying_strain_sens( TacsScalar strain[], TacsScalar dstrain[],
                            ...
                            const TacsScalar g12[],
                            const TacsScalar g23[], const TacsScalar g13[],
                            const TacsScalar dg11[], const TacsScalar dg22[],
                            const TacsScalar dg12[],
...
void add_tying_bmat_sens( TacsScalar B[], TacsScalar dB[],
                          ...
                          const TacsScalar db12[],
                          const TacsScalar db23[], const TacsScalar db13[],
                          const double N11[], const double N22[],
                          const double N12[] ){
