...
int TACSQuadraticQuadBernsteinBasis::getNumNodes(){
  return 9;
}

int TACSQuadraticQuadBernsteinBasis::getNumParameters(){
  return 2;
}

int TACSQuadraticQuadBernsteinBasis::getNumQuadraturePoints(){
  return 9;
}
...
double TACSQuadraticQuadBernsteinBasis::getQuadraturePoint( int n,
                                                            double pt[] ){
...
int TACSQuadraticQuadBernsteinBasis::getNumElementFaces(){
  return 4;
}
...
double TACSQuadraticQuadBernsteinBasis::getFaceQuadraturePoint( int face,
                                                                int n,
                                                                double pt[],
                                                                double t[] ){
  if (face/2 == 0){
...
int TACSCubicQuadBernsteinBasis::getNumNodes(){
  return 16;
}

int TACSCubicQuadBernsteinBasis::getNumParameters(){
  return 2;
}

int TACSCubicQuadBernsteinBasis::getNumQuadraturePoints(){
  return 16;
}
...
double TACSCubicQuadBernsteinBasis::getQuadraturePoint( int n,
                                                        double pt[] ){
...
int TACSCubicQuadBernsteinBasis::getNumElementFaces(){
  return 4;
}
...
double TACSCubicQuadBernsteinBasis::getFaceQuadraturePoint( int face,
                                                            int n,
                                                            double pt[],
                                                            double t[] ){
  if (face/2 == 0){
...
void TACSCubicQuadBernsteinBasis::computeBasis( const double pt[],
                                                double N[] ){
  double na[4], nb[4];
...
int TACSQuarticQuadBernsteinBasis::getNumNodes(){
  return 25;
}

int TACSQuarticQuadBernsteinBasis::getNumParameters(){
  return 2;
}

int TACSQuarticQuadBernsteinBasis::getNumQuadraturePoints(){
  return 25;
}
...
double TACSQuarticQuadBernsteinBasis::getQuadraturePoint( int n,
                                                          double pt[] ){
...
int TACSQuarticQuadBernsteinBasis::getNumElementFaces(){
  return 4;
}
...
double TACSQuarticQuadBernsteinBasis::getFaceQuadraturePoint( int face,
                                                              int n,
                                                              double pt[],
                                                              double t[] ){
  if (face/2 == 0){
...
void TACSQuinticQuadBernsteinBasis::getVisPoint( int n, double pt[] ){
  static const double pts[6] = {-1.0, -0.8090169943749475, -0.30901699437494745,
                                0.30901699437494745, 0.8090169943749475, 1.0};
  pt[0] = pts[n % 6];
  pt[1] = pts[n/6];
}

int TACSQuinticQuadBernsteinBasis::getNumNodes(){
  return 36;
}

int TACSQuinticQuadBernsteinBasis::getNumParameters(){
  return 2;
}

int TACSQuinticQuadBernsteinBasis::getNumQuadraturePoints(){
  return 36;
}
...
double TACSQuinticQuadBernsteinBasis::getQuadraturePoint( int n,
                                                          double pt[] ){
...
int TACSQuinticQuadBernsteinBasis::getNumElementFaces(){
  return 4;
}
...
double TACSQuinticQuadBernsteinBasis::getFaceQuadraturePoint( int face,
                                                              int n,
                                                              double pt[],
                                                              double t[] ){
  if (face/2 == 0){
