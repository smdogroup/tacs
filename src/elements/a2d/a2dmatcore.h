...
namespace A2D {
  ...
  inline void Mat3x3GreenStrainForwardCore( const TacsScalar Ux[],
    ...
    Ed[1] = 0.5*(Uxd[1] + Uxd[3] +
                 Ux[0] * Uxd[1] + Ux[3] * Uxd[4] + Ux[6] * Uxd[7] +
                 Uxd[0] * Ux[1] + Uxd[3] * Ux[4] + Uxd[6] * Ux[7]);
    Ed[2] = 0.5*(Uxd[2] + Uxd[6] +
                 Ux[0] * Uxd[2] + Ux[3] * Uxd[5] + Ux[6] * Uxd[8] +
                 Uxd[0] * Ux[2] + Uxd[3] * Ux[5] + Uxd[6] * Ux[8]);
    Ed[4] = 0.5*(Uxd[5] + Uxd[7] +
                 Ux[1] * Uxd[2] + Ux[4] * Uxd[5] + Ux[7] * Uxd[8] +
