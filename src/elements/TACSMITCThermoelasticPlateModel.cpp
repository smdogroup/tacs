...
TACSMITCThermoelasticPlateModel::TACSMITCThermoelasticPlateModel( TACSShellConstitutive *_con ){
  con = _con;
  con->incref();
}

TACSMITCThermoelasticPlateModel::~TACSMITCThermoelasticPlateModel(){
  con->decref();
}

const int TACSMITCThermoelasticPlateModel::linear_Jac_pairs[] =
  {2, 2,
   3, 3, 3, 4, 3, 8, 3, 9, 3, 18, 3, 19, 3, 23, 3, 24, 3, 25,
   4, 3, 4, 4, 4, 8, 4, 9, 4, 18, 4, 19, 4, 23, 4, 24, 4, 25,
   7, 7,
   8, 3, 8, 4, 8, 8, 8, 9, 8, 18, 8, 19, 8, 23, 8, 24, 8, 25,
   9, 3, 9, 4, 9, 8, 9, 9, 9, 18, 9, 19, 9, 23, 9, 24, 9, 25,
   12, 12,
   13, 13, 13, 14, 13, 15, 13, 20, 13, 25,
   14, 13, 14, 14, 14, 15, 14, 20, 14, 25,
   15, 13, 15, 14, 15, 15, 15, 20, 15, 25,
   18, 3, 18, 4, 18, 8, 18, 9, 18, 18, 18, 19, 18, 23, 18, 24, 18, 25,
   19, 3, 19, 4, 19, 8, 19, 9, 19, 18, 19, 19, 19, 23, 19, 24, 19, 25,
   20, 13, 20, 14, 20, 15, 20, 20, 20, 25,
   23, 3, 23, 4, 23, 8, 23, 9, 23, 18, 23, 19, 23, 23, 23, 24, 23, 25,
   24, 3, 24, 4, 24, 8, 24, 9, 24, 18, 24, 19, 24, 23, 24, 24, 24, 25,
   26, 26,
   28, 28, 28, 29,
   29, 28, 29, 29};

int TACSMITCThermoelasticPlateModel::getNumParameters(){
  return 2;
}

int TACSMITCThermoelasticPlateModel::getVarsPerNode(){
  return 6;
}

int TACSMITCThermoelasticPlateModel::getDesignVarsPerNode(){
  return con->getDesignVarsPerNode();
}

int TACSMITCThermoelasticPlateModel::getNumTyingFields(){
  return 2;
}
...
*/
int TACSMITCThermoelasticPlateModel::getDesignVarNums( int elemIndex,
                                                       int dvLen,
                                                       int dvNums[] ){
...
*/
int TACSMITCThermoelasticPlateModel::setDesignVars( int elemIndex,
                                                    int dvLen,
...
*/
int TACSMITCThermoelasticPlateModel::getDesignVars( int elemIndex,
                                                    int dvLen,
                                                    TacsScalar dvs[] ){
...
*/
int TACSMITCThermoelasticPlateModel::getDesignVarRange( int elemIndex,
                                                        int dvLen,
                                                        TacsScalar lb[],
                                                        TacsScalar ub[] ){
...
TacsScalar TACSMITCThermoelasticPlateModel::evalTyingQuantity( int field, int ty,
                                                               const double pt[],
                                                               const TacsScalar Xd[],
                                                               const TacsScalar U[],
                                                               const TacsScalar Ud[] ){
...
void TACSMITCThermoelasticPlateModel::evalTyingQuantitySVSens( int field, int ty,
                                                               const double pt[],
...
void TACSMITCThermoelasticPlateModel::evalWeakIntegrand( int elemIndex,
                                                         const double time,
                                                         int n,
                                                         const double pt[],
                                                         const TacsScalar X[],
  ...
  const TacsScalar *Uty = &Ut[6*3]; // 6 = vars_per_node
  ...
  TacsScalar *DUty = &DUt[3*6];
  DUty[0] = Q[0];
  DUty[1] = Q[1];
}

void TACSMITCThermoelasticPlateModel::getWeakMatrixNonzeros( ElementMatrixType matType,
                                                             int elemIndex,
                                                             int *Jac_nnz,
                                                             const int *Jac_pairs[] ){
...
void TACSMITCThermoelasticPlateModel::evalWeakMatrix( ElementMatrixType matType,
                                                      int elemIndex,
                                                      const double time,
                                                      int n,
                                                      const double pt[],
  ...
  Jac[7] = B[0];
  Jac[8] = B[2];
  Jac[9] = -A[0]*et[0] - A[1]*et[1] - A[2]*et[2] - B[0]*et[3] - B[1]*et[4] - B[2]*et[5];
  Jac[10] = A[2];
  Jac[11] = A[5];
  Jac[12] = A[5];
  Jac[13] = A[4];
  ...
  Jac[16] = B[2];
  Jac[17] = B[5];
  Jac[18] = -A[2]*et[0] - A[4]*et[1] - A[5]*et[2] - B[2]*et[3] - B[4]*et[4] - B[5]*et[5];
  Jac[19] = rho;
  Jac[20] = A[2];
  Jac[21] = A[5];
  Jac[22] = A[5];
  ...
  Jac[26] = B[2];
  Jac[27] = B[5];
  Jac[28] = -A[2]*et[0] - A[4]*et[1] - A[5]*et[2] - B[2]*et[3] - B[4]*et[4] - B[5]*et[5];
  Jac[29] = A[1];
  Jac[30] = A[4];
  Jac[31] = A[4];
  Jac[32] = A[3];
  ...
  Jac[35] = B[1];
  Jac[36] = B[4];
  Jac[37] = -A[1]*et[0] - A[3]*et[1] - A[4]*et[2] - B[1]*et[3] - B[3]*et[4] - B[4]*et[5];
  Jac[38] = rho;
  Jac[39] = As[2];
  Jac[40] = As[1];
  Jac[41] = -As[1];
  ...
  Jac[60] = -D[2];
  Jac[61] = -D[5];
  Jac[62] = B[2]*et[0] + B[4]*et[1] + B[5]*et[2] + D[2]*et[3] + D[4]*et[4] + D[5]*et[5];
  Jac[63] = -B[1];
  Jac[64] = -B[4];
  Jac[65] = -B[4];
  Jac[66] = -B[3];
  ...
  Jac[69] = -D[1];
  Jac[70] = -D[4];
  Jac[71] = B[1]*et[0] + B[3]*et[1] + B[4]*et[2] + D[1]*et[3] + D[3]*et[4] + D[4]*et[5];
  Jac[72] = As[2];
  Jac[73] = As[1];
  Jac[74] = -As[1];
  Jac[75] = As[2];
  ...
  Jac[83] = D[0];
  Jac[84] = D[2];
  Jac[85] = -B[0]*et[0] - B[1]*et[1] - B[2]*et[2] - D[0]*et[3] - D[1]*et[4] - D[2]*et[5];
  Jac[86] = B[2];
  Jac[87] = B[5];
  Jac[88] = B[5];
  Jac[89] = B[4];
  ...
  Jac[92] = D[2];
  Jac[93] = D[5];
  Jac[94] = -B[2]*et[0] - B[4]*et[1] - B[5]*et[2] - D[2]*et[3] - D[4]*et[4] - D[5]*et[5];
  Jac[95] = c*rho;
  Jac[96] = Kc[0];
  Jac[97] = Kc[1];
  Jac[98] = Kc[1];
...
*/
int TACSMITCThermoelasticPlateModel::evalPointQuantity( int elemIndex,
...
*/
void TACSMITCThermoelasticPlateModel::addPointQuantityDVSens( int elemIndex,
                                                              const int quantityType,
                                                              const double time,
                                                              TacsScalar scale,
                                                              int n, const double pt[],
...
*/
void TACSMITCThermoelasticPlateModel::evalPointQuantitySens( int elemIndex,
                                                             const int quantityType,
                                                             const double time,
                                                             int n, const double pt[],
                                                             const TacsScalar X[],
...
*/
void TACSMITCThermoelasticPlateModel::getOutputData( int elemIndex,
                                                     const double time,
                                                     ElementType etype,
                                                     int write_flag,
                                                     const double pt[],
