...
const double TacsTriangleWts4[] = { -27.0/96.0, 25.0/96.0, 25.0/96.0, 25.0/96.0 };
const double TacsTrianglePts4[] = { 1.0/3.0, 1.0/3.0, 1.0/5.0, 1.0/5.0,
                                    3.0/5.0, 1.0/5.0, 1.0/5.0, 3.0/5.0 };

const double TacsTriangleWts6[] = { 0.054975871827661, 0.054975871827661, 0.054975871827661,
