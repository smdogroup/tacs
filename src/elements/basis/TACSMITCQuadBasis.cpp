...
int TACSLinearMITCQuadBasis::getNumNodes(){
  return 4;
}

int TACSLinearMITCQuadBasis::getNumParameters(){
  return 2;
}

int TACSLinearMITCQuadBasis::getNumQuadraturePoints(){
  return 4;
}
...
double TACSLinearMITCQuadBasis::getQuadraturePoint( int n,
                                                    double pt[] ){
...
int TACSLinearMITCQuadBasis::getNumElementFaces(){
  return 4;
}

int TACSLinearMITCQuadBasis::getNumFaceQuadraturePoints( int face ){
  return 2;
}

double TACSLinearMITCQuadBasis::getFaceQuadraturePoint( int face,
                                                        int n,
                                                        double pt[],
                                                        double t[] ){
  if (face/2 == 0){
...
void TACSLinearMITCQuadBasis::computeBasis( const double pt[],
                                            double N[] ){
...
int TACSLinearMITCQuadBasis::getNumTyingFields(){
  return 2;
}

int TACSLinearMITCQuadBasis::getNumTyingPoints( int field ){
  return 2;
}
...
void TACSLinearMITCQuadBasis::computeTyingBasis( int field,
                                                 const double pt[],
                                                 double N[] ){
  if (field == 0){
    N[0] = 0.5*(1.0 - pt[1]);
...
int TACSQuadraticMITCQuadBasis::getNumNodes(){
  return 9;
}

int TACSQuadraticMITCQuadBasis::getNumParameters(){
  return 2;
}

int TACSQuadraticMITCQuadBasis::getNumQuadraturePoints(){
  return 9;
}
...
double TACSQuadraticMITCQuadBasis::getQuadraturePoint( int n,
                                                       double pt[] ){
...
int TACSQuadraticMITCQuadBasis::getNumElementFaces(){
  return 4;
}
...
double TACSQuadraticMITCQuadBasis::getFaceQuadraturePoint( int face,
                                                           int n,
                                                           double pt[],
                                                           double t[] ){
  if (face/2 == 0){
...
void TACSQuadraticMITCQuadBasis::computeBasis( const double pt[],
                                               double N[] ){
  double na[3];
...
int TACSQuadraticMITCQuadBasis::getNumTyingFields(){
  return 2;
}

int TACSQuadraticMITCQuadBasis::getNumTyingPoints( int field ){
  return 6;
}
...
void TACSQuadraticMITCQuadBasis::computeTyingBasis( int field,
                                                    const double pt[],
                                                    double N[] ){
  if (field == 0){
    double n0[2];
    n0[0] = (pt[0] - TacsGaussQuadPts2[1])/(TacsGaussQuadPts2[0] - TacsGaussQuadPts2[1]);
    n0[1] = (pt[0] - TacsGaussQuadPts2[0])/(TacsGaussQuadPts2[1] - TacsGaussQuadPts2[0]);
    ...
    double n0[2];
    n0[0] = (pt[1] - TacsGaussQuadPts2[1])/(TacsGaussQuadPts2[0] - TacsGaussQuadPts2[1]);
    n0[1] = (pt[1] - TacsGaussQuadPts2[0])/(TacsGaussQuadPts2[1] - TacsGaussQuadPts2[0]);
