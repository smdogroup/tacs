...
void TACSMITCBasis::getTyingPointGradient( int field, int ty,
                                           const double pt[],
...
void TACSMITCBasis::interpTyingField( int n,
                                      const double pt[],
...
void TACSMITCBasis::addInterpTyingFieldTranspose( int n,
                                                  const double pt[],
...
void TACSMITCBasis::addWeakResidual( int n,
                                     const double pt[],
                                     TacsScalar weight,
                                     const TacsScalar J[],
                                     const int vars_per_node,
...
*/
void TACSMITCBasis::addTyingResidual( int field, int ty,
                                      const double pt[],
                                      const int vars_per_node,
                                      const TacsScalar DU[],
