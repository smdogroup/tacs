...
*/
void TACSSphericalConstraint::addResidual( int elemIndex,
                                           double time,
...
*/
void TACSSphericalConstraint::addJacobian( int elemIndex,
                                           double time,
                                           TacsScalar alpha,
                                           TacsScalar beta,
                                           TacsScalar gamma,
...
/*
  Compute the residual of the governing equations
*/
void TACSRevoluteConstraint::addResidual( int elemIndex,
                                          double time,
                                          const TacsScalar *Xpts,
                                          const TacsScalar *vars,
                                          const TacsScalar *dvars,
...
/*
  Compute the Jacobian of the residuals of the governing equations
*/
void TACSRevoluteConstraint::addJacobian( int elemIndex,
                                          double time,
                                          TacsScalar alpha,
                                          TacsScalar beta,
                                          TacsScalar gamma,
...
*/
int TACSRigidLink::getVarsPerNode(){
  return 8;
}
...
*/
const char* TACSRigidLink::getObjectName(){
  return elem_name;
}
...
/*
  Compute the residual of the governing equations
*/
void TACSRigidLink::addResidual( int elemIndex,
                                 double time,
                                 const TacsScalar *Xpts,
                                 const TacsScalar *vars,
                                 const TacsScalar *dvars,
...
*/
void TACSRigidLink::addJacobian( int elemIndex,
                                 double time,
                                 TacsScalar alpha,
                                 TacsScalar beta,
                                 TacsScalar gamma,
...
int TACSRevoluteDriver::getVarsPerNode(){
  return 8;
}

int TACSRevoluteDriver::getNumNodes(){
  return 2;
}

const char* TACSRevoluteDriver::getObjectName(){
  return "TACSRevoluteDriver";
}

const TacsScalar TACSRevoluteDriver::delta = 10.0;

void TACSRevoluteDriver::addResidual( int elemIndex,
                                      double time,
                                      const TacsScalar *Xpts,
                                      const TacsScalar *vars,
                                      const TacsScalar *dvars,
...
void TACSRevoluteDriver::addJacobian( int elemIndex,
                                      double time,
                                      TacsScalar alpha,
                                      TacsScalar beta,
                                      TacsScalar gamma,
...
*/
int TACSAverageConstraint::getVarsPerNode(){
  return 8;
}
...
*/
int TACSAverageConstraint::getNumNodes(){
  return 5;
}
...
/*
  The element name
*/
const char* TACSAverageConstraint::getObjectName(){
  return elem_name;
}
...
*/
void TACSAverageConstraint::addResidual( int elemIndex,
                                         double time,
                                         const TacsScalar *Xpts,
                                         const TacsScalar *vars,
                                         const TacsScalar *dvars,
...
void TACSAverageConstraint::addJacobian( int elemIndex,
                                         double time,
                                         TacsScalar alpha,
                                         TacsScalar beta,
                                         TacsScalar gamma,
...
/*
  Returns the number of nodes based on the constraint nature
*/
int TACSFixedConstraint::getNumNodes(){
  return 2;
}
...
/*
  Compute the residual of the governing equations
*/
void TACSFixedConstraint::addResidual( int elemIndex,
                                       double time,
                                       const TacsScalar *Xpts,
                                       const TacsScalar *vars,
                                       const TacsScalar *dvars,
