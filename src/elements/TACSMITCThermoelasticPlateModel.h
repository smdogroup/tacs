...
#ifndef TACS_MITC_THERMOELASTIC_PLATE_MODEL_H
#define TACS_MITC_THERMOELASTIC_PLATE_MODEL_H

#include "TACSShellConstitutive.h"
#include "TACSMITCModel.h"

class TACSMITCThermoelasticPlateModel : public TACSMITCModel {
 public:
  TACSMITCThermoelasticPlateModel( TACSShellConstitutive *_con );
  ~TACSMITCThermoelasticPlateModel();
  ...
  */
  TacsScalar evalTyingQuantity( int field, int ty, const double pt[],
                                const TacsScalar Xd[],
                                const TacsScalar U[], const TacsScalar Ud[] );

  /**
    Evaluate the derivatives of the tying point quantity w.r.t. the degrees
    of freedom
  */
  void evalTyingQuantitySVSens( int field, int ty, const double pt[],
                                const TacsScalar dfdqty,
                                const TacsScalar Xd[],
                                const TacsScalar U[], const TacsScalar Ud[],
                                TacsScalar DU[], TacsScalar DUd[] );
...
#endif // TACS_MITC_THERMOELASTIC_PLATE_MODEL_H
