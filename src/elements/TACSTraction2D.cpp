...
int TACSTraction2D::getNumNodes(){
  return basis->getNumNodes();
}

ElementLayout TACSTraction2D::getLayoutType(){
  return basis->getLayoutType();
}

TACSElementBasis* TACSTraction2D::getElementBasis(){
  return basis;
}
...
int TACSTraction2D::getNumElementFaces(){
...
*/
void TACSTraction2D::addResidual( int elemIndex,
                                  double time,
...
*/
void TACSTraction2D::addJacobian( int elemIndex,
                                  double time,
                                  TacsScalar alpha,
                                  TacsScalar beta,
                                  TacsScalar gamma,
