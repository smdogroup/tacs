...
TACSConvectiveTraction2D::TACSConvectiveTraction2D( int _varsPerNode,
                                                    int _faceIndex,
                                                    int _fieldIndex,
                                                    TacsScalar _alpha,
...
int TACSConvectiveTraction2D::getVarsPerNode(){
  return varsPerNode;
}

int TACSConvectiveTraction2D::getNumNodes(){
...
TACSElementBasis* TACSConvectiveTraction2D::getElementBasis(){
  return basis;
}
...
*/
void TACSConvectiveTraction2D::addResidual( int elemIndex,
                                            double time,
...
*/
void TACSConvectiveTraction2D::addJacobian( int elemIndex,
                                            double time,
                                            TacsScalar alpha,
                                            TacsScalar beta,
                                            TacsScalar gamma,
...
void TACSConvectiveTraction2D::addAdjResProduct( int elemIndex,
                                                 double time,
                                                 TacsScalar scale,
...
void TACSConvectiveTraction2D::addAdjResXptProduct( int elemIndex,
                                                    double time,
                                                    TacsScalar scale,
                                                    const TacsScalar psi[],
                                                    const TacsScalar Xpts[],
