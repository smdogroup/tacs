  ...
  for ( int n = 0; n < 36; n++ ){
    ...
    for ( int k = 0; k < 6; k++ ){
      for ( int j = 0; j < 6; j++ ){
        ...
        v[0] +=  (a[0]*n11[0]  + b[0]*n1x1[0]  + a[3]*n12[0]  + b[3]*n1x2[0] +
                  a[6]*n13[0]  + b[6]*n1x3[0]  + a[9]*n14[0]  + b[9]*n1x4[0] +
                  a[12]*n15[0] + b[12]*n1x5[0] + a[15]*n16[0] + b[15]*n1x6[0]);
        v[1] +=  (a[1]*n11[0]  + b[1]*n1x1[0]  + a[4]*n12[0]  + b[4]*n1x2[0] +
                  a[7]*n13[0]  + b[7]*n1x3[0]  + a[10]*n14[0] + b[10]*n1x4[0] +
                  a[13]*n15[0] + b[13]*n1x5[0] + a[16]*n16[0] + b[16]*n1x6[0]);
        v[2] +=  (a[2]*n11[0]  + b[2]*n1x1[0]  + a[5]*n12[0]  + b[5]*n1x2[0] +
                  a[8]*n13[0]  + b[8]*n1x3[0]  + a[11]*n14[0] + b[11]*n1x4[0] +
                  a[14]*n15[0] + b[14]*n1x5[0] + a[17]*n16[0] + b[17]*n1x6[0]);
        v[3] +=  (a[0]*n11[1]  + b[0]*n1x1[1]  + a[3]*n12[1]  + b[3]*n1x2[1] +
                  a[6]*n13[1]  + b[6]*n1x3[1]  + a[9]*n14[1]  + b[9]*n1x4[1] +
                  a[12]*n15[1] + b[12]*n1x5[1] + a[15]*n16[1] + b[15]*n1x6[1]);
        v[4] +=  (a[1]*n11[1]  + b[1]*n1x1[1]  + a[4]*n12[1]  + b[4]*n1x2[1] +
                  a[7]*n13[1]  + b[7]*n1x3[1]  + a[10]*n14[1] + b[10]*n1x4[1] +
                  a[13]*n15[1] + b[13]*n1x5[1] + a[16]*n16[1] + b[16]*n1x6[1]);
        v[5] +=  (a[2]*n11[1]  + b[2]*n1x1[1]  + a[5]*n12[1]  + b[5]*n1x2[1] +
                  a[8]*n13[1]  + b[8]*n1x3[1]  + a[11]*n14[1] + b[11]*n1x4[1] +
                  a[14]*n15[1] + b[14]*n1x5[1] + a[17]*n16[1] + b[17]*n1x6[1]);
        v[6] +=  (a[0]*n11[2]  + b[0]*n1x1[2]  + a[3]*n12[2]  + b[3]*n1x2[2] +
                  a[6]*n13[2]  + b[6]*n1x3[2]  + a[9]*n14[2]  + b[9]*n1x4[2] +
                  a[12]*n15[2] + b[12]*n1x5[2] + a[15]*n16[2] + b[15]*n1x6[2]);
        v[7] +=  (a[1]*n11[2]  + b[1]*n1x1[2]  + a[4]*n12[2]  + b[4]*n1x2[2] +
                  a[7]*n13[2]  + b[7]*n1x3[2]  + a[10]*n14[2] + b[10]*n1x4[2] +
                  a[13]*n15[2] + b[13]*n1x5[2] + a[16]*n16[2] + b[16]*n1x6[2]);
        v[8] +=  (a[2]*n11[2]  + b[2]*n1x1[2]  + a[5]*n12[2]  + b[5]*n1x2[2] +
                  a[8]*n13[2]  + b[8]*n1x3[2]  + a[11]*n14[2] + b[11]*n1x4[2] +
                  a[14]*n15[2] + b[14]*n1x5[2] + a[17]*n16[2] + b[17]*n1x6[2]);
        v[9] +=  (a[0]*n11[3]  + b[0]*n1x1[3]  + a[3]*n12[3]  + b[3]*n1x2[3] +
                  a[6]*n13[3]  + b[6]*n1x3[3]  + a[9]*n14[3]  + b[9]*n1x4[3] +
                  a[12]*n15[3] + b[12]*n1x5[3] + a[15]*n16[3] + b[15]*n1x6[3]);
        v[10] += (a[1]*n11[3]  + b[1]*n1x1[3]  + a[4]*n12[3]  + b[4]*n1x2[3] +
                  a[7]*n13[3]  + b[7]*n1x3[3]  + a[10]*n14[3] + b[10]*n1x4[3] +
                  a[13]*n15[3] + b[13]*n1x5[3] + a[16]*n16[3] + b[16]*n1x6[3]);
        v[11] += (a[2]*n11[3]  + b[2]*n1x1[3]  + a[5]*n12[3]  + b[5]*n1x2[3] +
                  a[8]*n13[3]  + b[8]*n1x3[3]  + a[11]*n14[3] + b[11]*n1x4[3] +
                  a[14]*n15[3] + b[14]*n1x5[3] + a[17]*n16[3] + b[17]*n1x6[3]);
        v[12] += (a[0]*n11[4]  + b[0]*n1x1[4]  + a[3]*n12[4]  + b[3]*n1x2[4] +
                  a[6]*n13[4]  + b[6]*n1x3[4]  + a[9]*n14[4]  + b[9]*n1x4[4] +
                  a[12]*n15[4] + b[12]*n1x5[4] + a[15]*n16[4] + b[15]*n1x6[4]);
        v[13] += (a[1]*n11[4]  + b[1]*n1x1[4]  + a[4]*n12[4]  + b[4]*n1x2[4] +
                  a[7]*n13[4]  + b[7]*n1x3[4]  + a[10]*n14[4] + b[10]*n1x4[4] +
                  a[13]*n15[4] + b[13]*n1x5[4] + a[16]*n16[4] + b[16]*n1x6[4]);
        v[14] += (a[2]*n11[4]  + b[2]*n1x1[4]  + a[5]*n12[4]  + b[5]*n1x2[4] +
                  a[8]*n13[4]  + b[8]*n1x3[4]  + a[11]*n14[4] + b[11]*n1x4[4] +
                  a[14]*n15[4] + b[14]*n1x5[4] + a[17]*n16[4] + b[17]*n1x6[4]);
        v[15] += (a[0]*n11[5]  + b[0]*n1x1[5]  + a[3]*n12[5]  + b[3]*n1x2[5] +
                  a[6]*n13[5]  + b[6]*n1x3[5]  + a[9]*n14[5]  + b[9]*n1x4[5] +
                  a[12]*n15[5] + b[12]*n1x5[5] + a[15]*n16[5] + b[15]*n1x6[5]);
        v[16] += (a[1]*n11[5]  + b[1]*n1x1[5]  + a[4]*n12[5]  + b[4]*n1x2[5] +
                  a[7]*n13[5]  + b[7]*n1x3[5]  + a[10]*n14[5] + b[10]*n1x4[5] +
                  a[13]*n15[5] + b[13]*n1x5[5] + a[16]*n16[5] + b[16]*n1x6[5]);
        v[17] += (a[2]*n11[5]  + b[2]*n1x1[5]  + a[5]*n12[5]  + b[5]*n1x2[5] +
                  a[8]*n13[5]  + b[8]*n1x3[5]  + a[11]*n14[5] + b[11]*n1x4[5] +
                  a[14]*n15[5] + b[14]*n1x5[5] + a[17]*n16[5] + b[17]*n1x6[5]);
  ...
  for ( int n = 0; n < 36; n++ ){
    ...
    for ( int k = 0; k < 6; k++ ){
      for ( int j = 0; j < 6; j++ ){
        ...
        v[0] += (a[0]*n11[0]  + b[0]*n1x1[0]  + a[4]*n12[0]  + b[4]*n1x2[0] +
                 a[8]*n13[0]  + b[8]*n1x3[0]  + a[12]*n14[0] + b[12]*n1x4[0] +
                 a[16]*n15[0] + b[16]*n1x5[0] + a[20]*n16[0] + b[20]*n1x6[0]);
        v[1] += (a[1]*n11[0]  + b[1]*n1x1[0]  + a[5]*n12[0]  + b[5]*n1x2[0] +
                 a[9]*n13[0]  + b[9]*n1x3[0]  + a[13]*n14[0] + b[13]*n1x4[0] +
                 a[17]*n15[0] + b[17]*n1x5[0] + a[21]*n16[0] + b[21]*n1x6[0]);
        v[2] += (a[2]*n11[0]  + b[2]*n1x1[0]  + a[6]*n12[0]  + b[6]*n1x2[0] +
                 a[10]*n13[0] + b[10]*n1x3[0] + a[14]*n14[0] + b[14]*n1x4[0] +
                 a[18]*n15[0] + b[18]*n1x5[0] + a[22]*n16[0] + b[22]*n1x6[0]);
        v[3] += (a[3]*n11[0]  + b[3]*n1x1[0]  + a[7]*n12[0]  + b[7]*n1x2[0] +
                 a[11]*n13[0] + b[11]*n1x3[0] + a[15]*n14[0] + b[15]*n1x4[0] +
                 a[19]*n15[0] + b[19]*n1x5[0] + a[23]*n16[0] + b[23]*n1x6[0]);
        v[4] += (a[0]*n11[1]  + b[0]*n1x1[1]  + a[4]*n12[1]  + b[4]*n1x2[1] +
                 a[8]*n13[1]  + b[8]*n1x3[1]  + a[12]*n14[1] + b[12]*n1x4[1] +
                 a[16]*n15[1] + b[16]*n1x5[1] + a[20]*n16[1] + b[20]*n1x6[1]);
        v[5] += (a[1]*n11[1]  + b[1]*n1x1[1]  + a[5]*n12[1]  + b[5]*n1x2[1] +
                 a[9]*n13[1]  + b[9]*n1x3[1]  + a[13]*n14[1] + b[13]*n1x4[1] +
                 a[17]*n15[1] + b[17]*n1x5[1] + a[21]*n16[1] + b[21]*n1x6[1]);
        v[6] += (a[2]*n11[1]  + b[2]*n1x1[1]  + a[6]*n12[1]  + b[6]*n1x2[1] +
                 a[10]*n13[1] + b[10]*n1x3[1] + a[14]*n14[1] + b[14]*n1x4[1] +
                 a[18]*n15[1] + b[18]*n1x5[1] + a[22]*n16[1] + b[22]*n1x6[1]);
        v[7] += (a[3]*n11[1]  + b[3]*n1x1[1]  + a[7]*n12[1]  + b[7]*n1x2[1] +
                 a[11]*n13[1] + b[11]*n1x3[1] + a[15]*n14[1] + b[15]*n1x4[1] +
                 a[19]*n15[1] + b[19]*n1x5[1] + a[23]*n16[1] + b[23]*n1x6[1]);
        v[8] += (a[0]*n11[2]  + b[0]*n1x1[2]  + a[4]*n12[2]  + b[4]*n1x2[2] +
                 a[8]*n13[2]  + b[8]*n1x3[2]  + a[12]*n14[2] + b[12]*n1x4[2] +
                 a[16]*n15[2] + b[16]*n1x5[2] + a[20]*n16[2] + b[20]*n1x6[2]);
        v[9] += (a[1]*n11[2]  + b[1]*n1x1[2]  + a[5]*n12[2]  + b[5]*n1x2[2] +
                 a[9]*n13[2]  + b[9]*n1x3[2]  + a[13]*n14[2] + b[13]*n1x4[2] +
                 a[17]*n15[2] + b[17]*n1x5[2] + a[21]*n16[2] + b[21]*n1x6[2]);
        v[10] += (a[2]*n11[2]  + b[2]*n1x1[2]  + a[6]*n12[2]  + b[6]*n1x2[2] +
                  a[10]*n13[2] + b[10]*n1x3[2] + a[14]*n14[2] + b[14]*n1x4[2] +
                  a[18]*n15[2] + b[18]*n1x5[2] + a[22]*n16[2] + b[22]*n1x6[2]);
        v[11] += (a[3]*n11[2]  + b[3]*n1x1[2]  + a[7]*n12[2]  + b[7]*n1x2[2] +
                  a[11]*n13[2] + b[11]*n1x3[2] + a[15]*n14[2] + b[15]*n1x4[2] +
                  a[19]*n15[2] + b[19]*n1x5[2] + a[23]*n16[2] + b[23]*n1x6[2]);
        v[12] += (a[0]*n11[3]  + b[0]*n1x1[3]  + a[4]*n12[3]  + b[4]*n1x2[3] +
                  a[8]*n13[3]  + b[8]*n1x3[3]  + a[12]*n14[3] + b[12]*n1x4[3] +
                  a[16]*n15[3] + b[16]*n1x5[3] + a[20]*n16[3] + b[20]*n1x6[3]);
        v[13] += (a[1]*n11[3]  + b[1]*n1x1[3]  + a[5]*n12[3]  + b[5]*n1x2[3] +
                  a[9]*n13[3]  + b[9]*n1x3[3]  + a[13]*n14[3] + b[13]*n1x4[3] +
                  a[17]*n15[3] + b[17]*n1x5[3] + a[21]*n16[3] + b[21]*n1x6[3]);
        v[14] += (a[2]*n11[3]  + b[2]*n1x1[3]  + a[6]*n12[3]  + b[6]*n1x2[3] +
                  a[10]*n13[3] + b[10]*n1x3[3] + a[14]*n14[3] + b[14]*n1x4[3] +
                  a[18]*n15[3] + b[18]*n1x5[3] + a[22]*n16[3] + b[22]*n1x6[3]);
        v[15] += (a[3]*n11[3]  + b[3]*n1x1[3]  + a[7]*n12[3]  + b[7]*n1x2[3] +
                  a[11]*n13[3] + b[11]*n1x3[3] + a[15]*n14[3] + b[15]*n1x4[3] +
                  a[19]*n15[3] + b[19]*n1x5[3] + a[23]*n16[3] + b[23]*n1x6[3]);
        v[16] += (a[0]*n11[4]  + b[0]*n1x1[4]  + a[4]*n12[4]  + b[4]*n1x2[4] +
                  a[8]*n13[4]  + b[8]*n1x3[4]  + a[12]*n14[4] + b[12]*n1x4[4] +
                  a[16]*n15[4] + b[16]*n1x5[4] + a[20]*n16[4] + b[20]*n1x6[4]);
        v[17] += (a[1]*n11[4]  + b[1]*n1x1[4]  + a[5]*n12[4]  + b[5]*n1x2[4] +
                  a[9]*n13[4]  + b[9]*n1x3[4]  + a[13]*n14[4] + b[13]*n1x4[4] +
                  a[17]*n15[4] + b[17]*n1x5[4] + a[21]*n16[4] + b[21]*n1x6[4]);
        v[18] += (a[2]*n11[4]  + b[2]*n1x1[4]  + a[6]*n12[4]  + b[6]*n1x2[4] +
                  a[10]*n13[4] + b[10]*n1x3[4] + a[14]*n14[4] + b[14]*n1x4[4] +
                  a[18]*n15[4] + b[18]*n1x5[4] + a[22]*n16[4] + b[22]*n1x6[4]);
        v[19] += (a[3]*n11[4]  + b[3]*n1x1[4]  + a[7]*n12[4]  + b[7]*n1x2[4] +
                  a[11]*n13[4] + b[11]*n1x3[4] + a[15]*n14[4] + b[15]*n1x4[4] +
                  a[19]*n15[4] + b[19]*n1x5[4] + a[23]*n16[4] + b[23]*n1x6[4]);
        v[20] += (a[0]*n11[5]  + b[0]*n1x1[5]  + a[4]*n12[5]  + b[4]*n1x2[5] +
                  a[8]*n13[5]  + b[8]*n1x3[5]  + a[12]*n14[5] + b[12]*n1x4[5] +
                  a[16]*n15[5] + b[16]*n1x5[5] + a[20]*n16[5] + b[20]*n1x6[5]);
        v[21] += (a[1]*n11[5]  + b[1]*n1x1[5]  + a[5]*n12[5]  + b[5]*n1x2[5] +
                  a[9]*n13[5]  + b[9]*n1x3[5]  + a[13]*n14[5] + b[13]*n1x4[5] +
                  a[17]*n15[5] + b[17]*n1x5[5] + a[21]*n16[5] + b[21]*n1x6[5]);
        v[22] += (a[2]*n11[5]  + b[2]*n1x1[5]  + a[6]*n12[5]  + b[6]*n1x2[5] +
                  a[10]*n13[5] + b[10]*n1x3[5] + a[14]*n14[5] + b[14]*n1x4[5] +
                  a[18]*n15[5] + b[18]*n1x5[5] + a[22]*n16[5] + b[22]*n1x6[5]);
        v[23] += (a[3]*n11[5]  + b[3]*n1x1[5]  + a[7]*n12[5]  + b[7]*n1x2[5] +
                  a[11]*n13[5] + b[11]*n1x3[5] + a[15]*n14[5] + b[15]*n1x4[5] +
                  a[19]*n15[5] + b[19]*n1x5[5] + a[23]*n16[5] + b[23]*n1x6[5]);
        v += 24;
      }
    }
    in += 96;
