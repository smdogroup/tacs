...
TACSThermoelasticPlateModel::TACSThermoelasticPlateModel( TACSShellConstitutive *_con ){
  con = _con;
  con->incref();
}
...
int TACSThermoelasticPlateModel::getVarsPerNode(){
  return 6;
}
...
*/
int TACSThermoelasticPlateModel::getDesignVarNums( int elemIndex,
                                                   int dvLen,
                                                   int dvNums[] ){
...
*/
int TACSThermoelasticPlateModel::setDesignVars( int elemIndex,
                                                int dvLen,
...
*/
int TACSThermoelasticPlateModel::getDesignVars( int elemIndex,
                                                int dvLen,
                                                TacsScalar dvs[] ){
...
*/
int TACSThermoelasticPlateModel::getDesignVarRange( int elemIndex,
                                                    int dvLen,
                                                    TacsScalar lb[],
                                                    TacsScalar ub[] ){
...
void TACSThermoelasticPlateModel::evalWeakIntegrand( int elemIndex,
                                                     const double time,
                                                     int n,
                                                     const double pt[],
                                                     const TacsScalar X[],
...
*/
int TACSThermoelasticPlateModel::evalPointQuantity( int elemIndex,
...
*/
void TACSThermoelasticPlateModel::addPointQuantityDVSens( int elemIndex,
                                                          const int quantityType,
                                                          const double time,
                                                          TacsScalar scale,
                                                          int n, const double pt[],
...
*/
void TACSThermoelasticPlateModel::evalPointQuantitySens( int elemIndex,
                                                         const int quantityType,
                                                         const double time,
                                                         int n, const double pt[],
                                                         const TacsScalar X[],
...
*/
void TACSThermoelasticPlateModel::getOutputData( int elemIndex,
                                                 const double time,
                                                 ElementType etype,
                                                 int write_flag,
                                                 const double pt[],
