...
*/
const char* TACSMomentOfInertia::getObjectName(){
  return funcName;
}
...
/*
  ...
  design variables
*/
void TACSMomentOfInertia::addElementDVSens( int elemIndex,
                                            TACSElement *element,
                                            double time,
                                            TacsScalar scale,
                                            const TacsScalar Xpts[],
...
/*
  ...
  locations.
*/
void TACSMomentOfInertia::getElementXptSens( int elemIndex,
                                             TACSElement *element,
                                             double time,
                                             TacsScalar scale,
                                             const TacsScalar Xpts[],
  ...
  for ( int i = 0; i < element->getNumQuadraturePoints(); i++ ){
    ...
    if (count >= 1){
      ...
      element->addPointQuantityXptSens(elemIndex, TACS_ELEMENT_MOMENT_OF_INERTIA,
                                       time, 1.0, i, pt,
                                       Xpts, vars, dvars, ddvars,
                                       dfddetXd, dfdq, dfdXpts);
    }
