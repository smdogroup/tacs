...
TACSHeatFlux::TACSHeatFlux( TACSAssembler *_assembler,
                            int *elem_index,
                            int *face_index,
                            int num_elems ):
...
*/
const char *TACSHeatFlux::getObjectName(){
  return funcName;
}
...
*/
TacsScalar TACSHeatFlux::getFunctionValue(){
  return value;
}
...
*/
void TACSHeatFlux::initEvaluation( EvaluationType ftype ){
  value = 0.0;
}
...
*/
void TACSHeatFlux::elementWiseEval( EvaluationType ftype,
                                    int elemIndex,
                                    TACSElement *element,
                                    double time,
                                    TacsScalar scale,
...
*/
void TACSHeatFlux::getElementSVSens( int elemIndex, TACSElement *element,
                                     double time,
                                     TacsScalar alpha,
                                     TacsScalar beta,
                                     TacsScalar gamma,
...
*/
void TACSHeatFlux::getElementXptSens( int elemIndex,
                                      TACSElement *element,
                                      double time,
                                      TacsScalar scale,
                                      const TacsScalar Xpts[],
...
*/
void TACSHeatFlux::addElementDVSens( int elemIndex,
                                     TACSElement *element,
                                     double time,
                                     TacsScalar scale,
                                     const TacsScalar Xpts[],
