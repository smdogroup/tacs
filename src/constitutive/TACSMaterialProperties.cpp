...
MaterialType TACSMaterialProperties::getMaterialType(){
  return mat_type;
}
...
void TACSMaterialProperties::getOrthotropicProperties( TacsScalar *_E1,
                                                       TacsScalar *_E2,
                                                       TacsScalar *_E3,
                                                       TacsScalar *_nu12,
                                                       TacsScalar *_nu13,
...
void TACSMaterialProperties::getStrengthProperties( TacsScalar *_T1,
                                                    TacsScalar *_C1,
                                                    TacsScalar *_T2,
                                                    TacsScalar *_C2,
                                                    TacsScalar *_T3,
...
TacsScalar TACSMaterialProperties::vonMisesFailure3DStressSens( const TacsScalar s[],
                                                                TacsScalar sens[] ){
  TacsScalar fail = sqrt(0.5*((s[0] - s[1])*(s[0] - s[1]) +
                              (s[0] - s[2])*(s[0] - s[2]) +
                              (s[1] - s[2])*(s[1] - s[2]) +
...
TacsScalar TACSMaterialProperties::vonMisesFailure2DStressSens( const TacsScalar s[],
                                                                TacsScalar sens[] ){
...
TACSOrthotropicPly::TACSOrthotropicPly( TacsScalar _plyThickness,
  ...
  properties->getOrthotropicProperties(&E1, &E2, NULL, &nu12, NULL, NULL,
                                       &G12, &G13, &G23);
  nu21 = nu12*E2/E1;
  ...
  properties->getStrengthProperties(&Xt, &Xc, &Yt, &Yc, NULL, NULL,
                                    &S12, NULL, NULL);
  C = 0.0;
  ...
  if (TacsRealPart(F12*F12) >= TacsRealPart(F11*F22)){
    fprintf(stderr, "TACSOrthotropicPly: Value of C = %e results in "
...
*/
void TACSOrthotropicPly::calculateAbarAngleSens( TacsScalar angle, TacsScalar Abar[] ){
...
*/
void TACSOrthotropicPly::calculateQbarAngleSens( TacsScalar angle, TacsScalar Qbar[] ){
  TacsScalar cos1 = cos(angle);
  TacsScalar sin1 = sin(angle);
...
/*
  ...
  strain components.
*/
TacsScalar TACSOrthotropicPly::calculateFailLoadStrainSens( TacsScalar angle,
                                                            const TacsScalar cstrain[],
                                                            const TacsScalar lstrain[],
                                                            TacsScalar cSens[],
                                                            TacsScalar lSens[] ){
...
*/
TacsScalar TACSOrthotropicPly::calculateFailLoadAngleSens( TacsScalar angle,
                                                           const TacsScalar cstrain[],
                                                           const TacsScalar lstrain[],
                                                           TacsScalar *posSens ){
...
void TACSOrthotropicPly::transformStressGlobal2PlyAngleSens( TacsScalar angle ,
                                                             const TacsScalar global[],
                                                             TacsScalar plyStress[] ){
  TacsScalar cos1 = cos(angle);
  TacsScalar sin1 = sin(angle);
...
// Transform stress from the ply frame to the global frame
void TACSOrthotropicPly::transformStressPly2GlobalAngleSens( TacsScalar angle,
                                                             const TacsScalar plyStress[],
                                                             TacsScalar global[] ){
  TacsScalar cos1 = cos(angle);
  TacsScalar sin1 = sin(angle);
...
void TACSOrthotropicPly::transformStrainGlobal2PlyAngleSens( TacsScalar angle,
                                                             const TacsScalar global[],
                                                             TacsScalar plyStrain[] ){
  TacsScalar cos1 = cos(angle);
  TacsScalar sin1 = sin(angle);
...
// Transform stress from the ply frame to the global frame
void TACSOrthotropicPly::transformStrainPly2GlobalAngleSens( TacsScalar angle,
                                                             const TacsScalar plyStrain[],
                                                             TacsScalar global[] ){
  TacsScalar cos1 = cos(angle);
  TacsScalar sin1 = sin(angle);
