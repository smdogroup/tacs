...
const char *TACSTimoshenkoConstitutive::constName = "TACSTimoshenkoConstitutive";

const char *TACSTimoshenkoConstitutive::getObjectName(){
  return constName;
}
...
*/
TACSTimoshenkoConstitutive::TACSTimoshenkoConstitutive( const TacsScalar _axis[],
                                                        TacsScalar EA,
                                                        TacsScalar EI22,
                                                        TacsScalar EI33,
                                                        TacsScalar EI23,
...
*/
TACSTimoshenkoConstitutive::TACSTimoshenkoConstitutive( TacsScalar rhoA,
                                                        TacsScalar rhoIy,
                                                        TacsScalar rhoIz,
                                                        TacsScalar rhoIyz,
                                                        TacsScalar EA,
...
*/
int TACSTimoshenkoConstitutive::getNumStresses(){
  return 6;
}
...
*/
TacsScalar TACSTimoshenkoConstitutive::evalDensity( int elemIndex,
                                                    const double pt[],
                                                    const TacsScalar X[] ){
  return rho[0];
}

TacsScalar TACSTimoshenkoConstitutive::evalSpecificHeat( int elemIndex,
                                                         const double pt[],
                                                         const TacsScalar X[] ){
  return 0.0;
}
...
void TACSTimoshenkoConstitutive::evalStress( int elemIndex,
                                             const double pt[],
                                             const TacsScalar X[],
                                             const TacsScalar e[],
                                             TacsScalar s[] ){
...
void TACSTimoshenkoConstitutive::evalTangentStiffness( int elemIndex,
                                                       const double pt[],
                                                       const TacsScalar X[],
                                                       TacsScalar _C[] ){
  memcpy(_C, C, 36*sizeof(TacsScalar));
