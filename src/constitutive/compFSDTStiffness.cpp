...
/*
  ...
  variables.
*/
compFSDTStiffness::compFSDTStiffness( OrthoPly **_ortho_ply, 
				      TacsScalar _kcorr,
...
compFSDTStiffness::~compFSDTStiffness(){
  ...
  if (ply_angles){ delete [] ply_angles; }
}
...
const char *compFSDTStiffness::constitutiveName(){ 
  return constName;
}
...
*/
TacsScalar compFSDTStiffness::getStiffness( const double gpt[],
                                            TacsScalar A[], 
                                            TacsScalar B[],
                                            TacsScalar D[], 
                                            TacsScalar As[] ){
...
*/
void compFSDTStiffness::failure( const double pt[], 
