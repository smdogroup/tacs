...
GaussianProcessModel::GaussianProcessModel(int n_train, int n_param, TacsScalar Xtrain[], TacsScalar alpha[]) {
...
TacsScalar GaussianProcessModel::predictMeanTestData(const TacsScalar* Xtest) {
    ...
    // iterate over each training data point, get the cross-term covariance and add the coefficient alpha for it
