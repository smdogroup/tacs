...
void BCSRMatApplyLower8( BCSRMatData * data, TacsScalar * x, TacsScalar * y ){
  ...
  for ( int i = 0; i < nrows; i++ ){
    ...
    for ( ; k < end; k++ ){
      ...
      z[3] -= a[24]*y[j] + a[25]*y[j+1] + a[26]*y[j+2] + a[27]*y[j+3] + a[28]*y[j+4] + a[29]*y[j+5] + a[30]*y[j+6] + a[31]*y[j+7];
      z[4] -= a[32]*y[j] + a[33]*y[j+1] + a[34]*y[j+2] + a[35]*y[j+3] + a[36]*y[j+4] + a[37]*y[j+5] + a[38]*y[j+6] + a[39]*y[j+7];
      z[5] -= a[40]*y[j] + a[41]*y[j+1] + a[42]*y[j+2] + a[43]*y[j+3] + a[44]*y[j+4] + a[45]*y[j+5] + a[46]*y[j+6] + a[47]*y[j+7];
      z[6] -= a[48]*y[j] + a[49]*y[j+1] + a[50]*y[j+2] + a[51]*y[j+3] + a[52]*y[j+4] + a[53]*y[j+5] + a[54]*y[j+6] + a[55]*y[j+7];
...
void BCSRMatApplyUpper8( BCSRMatData * data, TacsScalar * x, TacsScalar * y ){
  ...
  for ( int i = nrows-1; i >= 0; i-- ){
    ...
    for ( ; k < end; k++ ){
      ...
      y0 -= a[0 ]*y[j] + a[1 ]*y[j+1] + a[2 ]*y[j+2] + a[3 ]*y[j+3] + a[4 ]*y[j+4] + a[5 ]*y[j+5] + a[6 ]*y[j+6] + a[7 ]*y[j+7];
      y1 -= a[8 ]*y[j] + a[9 ]*y[j+1] + a[10]*y[j+2] + a[11]*y[j+3] + a[12]*y[j+4] + a[13]*y[j+5] + a[14]*y[j+6] + a[15]*y[j+7];
      y2 -= a[16]*y[j] + a[17]*y[j+1] + a[18]*y[j+2] + a[19]*y[j+3] + a[20]*y[j+4] + a[21]*y[j+5] + a[22]*y[j+6] + a[23]*y[j+7];
      y3 -= a[24]*y[j] + a[25]*y[j+1] + a[26]*y[j+2] + a[27]*y[j+3] + a[28]*y[j+4] + a[29]*y[j+5] + a[30]*y[j+6] + a[31]*y[j+7];
      y4 -= a[32]*y[j] + a[33]*y[j+1] + a[34]*y[j+2] + a[35]*y[j+3] + a[36]*y[j+4] + a[37]*y[j+5] + a[38]*y[j+6] + a[39]*y[j+7];
      y5 -= a[40]*y[j] + a[41]*y[j+1] + a[42]*y[j+2] + a[43]*y[j+3] + a[44]*y[j+4] + a[45]*y[j+5] + a[46]*y[j+6] + a[47]*y[j+7];
      y6 -= a[48]*y[j] + a[49]*y[j+1] + a[50]*y[j+2] + a[51]*y[j+3] + a[52]*y[j+4] + a[53]*y[j+5] + a[54]*y[j+6] + a[55]*y[j+7];
      y7 -= a[56]*y[j] + a[57]*y[j+1] + a[58]*y[j+2] + a[59]*y[j+3] + a[60]*y[j+4] + a[61]*y[j+5] + a[62]*y[j+6] + a[63]*y[j+7];
    ...
    y[bi]   = a[0 ]*y0 + a[1 ]*y1 + a[2 ]*y2 + a[3 ]*y3 + a[4 ]*y4 + a[5 ]*y5 + a[6 ]*y6 + a[7 ]*y7;
    y[bi+1] = a[8 ]*y0 + a[9 ]*y1 + a[10]*y2 + a[11]*y3 + a[12]*y4 + a[13]*y5 + a[14]*y6 + a[15]*y7;
    y[bi+2] = a[16]*y0 + a[17]*y1 + a[18]*y2 + a[19]*y3 + a[20]*y4 + a[21]*y5 + a[22]*y6 + a[23]*y7;
    y[bi+3] = a[24]*y0 + a[25]*y1 + a[26]*y2 + a[27]*y3 + a[28]*y4 + a[29]*y5 + a[30]*y6 + a[31]*y7;
    y[bi+4] = a[32]*y0 + a[33]*y1 + a[34]*y2 + a[35]*y3 + a[36]*y4 + a[37]*y5 + a[38]*y6 + a[39]*y7;
...
void BCSRMatApplyPartialLower8( BCSRMatData * data, TacsScalar * x, 
  ...
  for ( int i = var_offset+1; i < nrows; i++ ){
    ...
    for ( ; k < end; k++ ){
      ...
      xx[0] -= a[0 ]*x[j] + a[1 ]*x[j+1] + a[2 ]*x[j+2] + a[3 ]*x[j+3] + a[4 ]*x[j+4] + a[5 ]*x[j+5];
      xx[1] -= a[6 ]*x[j] + a[7 ]*x[j+1] + a[8 ]*x[j+2] + a[9 ]*x[j+3] + a[10]*x[j+4] + a[11]*x[j+5];
      xx[2] -= a[12]*x[j] + a[13]*x[j+1] + a[14]*x[j+2] + a[15]*x[j+3] + a[16]*x[j+4] + a[17]*x[j+5];
      xx[3] -= a[18]*x[j] + a[19]*x[j+1] + a[20]*x[j+2] + a[21]*x[j+3] + a[22]*x[j+4] + a[23]*x[j+5];
      xx[4] -= a[24]*x[j] + a[25]*x[j+1] + a[26]*x[j+2] + a[27]*x[j+3] + a[28]*x[j+4] + a[29]*x[j+5];
      xx[5] -= a[30]*x[j] + a[31]*x[j+1] + a[32]*x[j+2] + a[33]*x[j+3] + a[34]*x[j+4] + a[35]*x[j+5];
      a += 36;
    }
        ...
        for ( int jp = arowp[i]; jp < arowp[i+1]; jp++ ){
          ...
          for ( ; kp < kp_end; kp++ ){
            ...
            if (bcols[kp] == ccols[cp]){
              ...
              c[6 ] += a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5;
              c[12] += a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5;
              c[18] += a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5;
              c[24] += a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5;
              c[30] += a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5;

              b0 = b[1 ]; b1 = b[7 ]; b2 = b[13]; b3 = b[19]; b4 = b[25]; b5 = b[31];
              c[1 ] += a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5;
              c[7 ] += a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5;
              c[13] += a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5;
              c[19] += a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5;
              c[25] += a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5;
              c[31] += a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5;

              b0 = b[2 ]; b1 = b[8 ]; b2 = b[14]; b3 = b[20]; b4 = b[26]; b5 = b[32];
              c[2 ] += a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5;
              c[8 ] += a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5;
              c[14] += a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5;
              c[20] += a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5;
              c[26] += a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5;
              c[32] += a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5;

              b0 = b[3 ]; b1 = b[9 ]; b2 = b[15]; b3 = b[21]; b4 = b[27]; b5 = b[33];
              c[3 ] += a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5;
              c[9 ] += a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5;
              c[15] += a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5;
              c[21] += a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5;
              c[27] += a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5;
              c[33] += a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5;

              b0 = b[4 ]; b1 = b[10]; b2 = b[16]; b3 = b[22]; b4 = b[28]; b5 = b[34];
              c[4 ] += a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5;
              c[10] += a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5;
              c[16] += a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5;
              c[22] += a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5;
              c[28] += a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5;
              c[34] += a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5;

              b0 = b[5 ]; b1 = b[11]; b2 = b[17]; b3 = b[23]; b4 = b[29]; b5 = b[35];
              c[5 ] += a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5;
              c[11] += a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5;
              c[17] += a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5;
              c[23] += a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5;
              c[29] += a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5;
              c[35] += a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5;
            }
            b += 36;
          }
        }
        ...
        for ( int jp = arowp[i]; jp < arowp[i+1]; jp++ ){
          ...
          for ( ; kp < kp_end; kp++ ){
            ...
            if (bcols[kp] == ccols[cp]){
              ...
              b0 = b[0 ]; b1 = b[6 ]; b2 = b[12]; b3 = b[18]; b4 = b[24]; b5 = b[30];
              c[0 ] += alpha*(a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5);
              c[6 ] += alpha*(a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5);
              c[12] += alpha*(a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5);
              c[18] += alpha*(a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5);
              c[24] += alpha*(a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5);
              c[30] += alpha*(a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5);

              b0 = b[1 ]; b1 = b[7 ]; b2 = b[13]; b3 = b[19]; b4 = b[25]; b5 = b[31];
              c[1 ] += alpha*(a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5);
              c[7 ] += alpha*(a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5);
              c[13] += alpha*(a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5);
              c[19] += alpha*(a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5);
              c[25] += alpha*(a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5);
              c[31] += alpha*(a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5);

              b0 = b[2 ]; b1 = b[8 ]; b2 = b[14]; b3 = b[20]; b4 = b[26]; b5 = b[32];
              c[2 ] += alpha*(a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5);
              c[8 ] += alpha*(a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5);
              c[14] += alpha*(a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5);
              c[20] += alpha*(a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5);
              c[26] += alpha*(a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5);
              c[32] += alpha*(a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5);

              b0 = b[3 ]; b1 = b[9 ]; b2 = b[15]; b3 = b[21]; b4 = b[27]; b5 = b[33];
              c[3 ] += alpha*(a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5);
              c[9 ] += alpha*(a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5);
              c[15] += alpha*(a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5);
              c[21] += alpha*(a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5);
              c[27] += alpha*(a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5);
              c[33] += alpha*(a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5);

              b0 = b[4 ]; b1 = b[10]; b2 = b[16]; b3 = b[22]; b4 = b[28]; b5 = b[34];
              c[4 ] += alpha*(a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5);
              c[10] += alpha*(a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5);
              c[16] += alpha*(a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5);
              c[22] += alpha*(a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5);
              c[28] += alpha*(a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5);
              c[34] += alpha*(a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5);

              b0 = b[5 ]; b1 = b[11]; b2 = b[17]; b3 = b[23]; b4 = b[29]; b5 = b[35];
              c[5 ] += alpha*(a[0 ]*b0 + a[1 ]*b1 + a[2 ]*b2 + a[3 ]*b3 + a[4 ]*b4 + a[5 ]*b5);
              c[11] += alpha*(a[6 ]*b0 + a[7 ]*b1 + a[8 ]*b2 + a[9 ]*b3 + a[10]*b4 + a[11]*b5);
              c[17] += alpha*(a[12]*b0 + a[13]*b1 + a[14]*b2 + a[15]*b3 + a[16]*b4 + a[17]*b5);
              c[23] += alpha*(a[18]*b0 + a[19]*b1 + a[20]*b2 + a[21]*b3 + a[22]*b4 + a[23]*b5);
              c[29] += alpha*(a[24]*b0 + a[25]*b1 + a[26]*b2 + a[27]*b3 + a[28]*b4 + a[29]*b5);
              c[35] += alpha*(a[30]*b0 + a[31]*b1 + a[32]*b2 + a[33]*b3 + a[34]*b4 + a[35]*b5);
            }
...
void BCSRMatApplySOR8( BCSRMatData * data, TacsScalar * Adiag,
  ...
  for ( int iter = 0; iter < iters; iter++ ){
	...
	a += 36;
      ...
      TacsScalar * d = &Adiag[36*i];

      // Compute the first term in the update:
      // x[i] = (1.0 - omega)*x[i] + omega*D^{-1}tx
      x[6*i]   = (1.0 - omega)*x[6*i]   + omega*(d[0 ]*t1 + d[1 ]*t2 + d[2 ]*t3 + d[3 ]*t4 + d[4 ]*t5 + d[5 ]*t6);
      x[6*i+1] = (1.0 - omega)*x[6*i+1] + omega*(d[6 ]*t1 + d[7 ]*t2 + d[8 ]*t3 + d[9 ]*t4 + d[10]*t5 + d[11]*t6);
      x[6*i+2] = (1.0 - omega)*x[6*i+2] + omega*(d[12]*t1 + d[13]*t2 + d[14]*t3 + d[15]*t4 + d[16]*t5 + d[17]*t6);
      x[6*i+3] = (1.0 - omega)*x[6*i+3] + omega*(d[18]*t1 + d[19]*t2 + d[20]*t3 + d[21]*t4 + d[22]*t5 + d[23]*t6);
      x[6*i+4] = (1.0 - omega)*x[6*i+4] + omega*(d[24]*t1 + d[25]*t2 + d[26]*t3 + d[27]*t4 + d[28]*t5 + d[29]*t6);
      x[6*i+5] = (1.0 - omega)*x[6*i+5] + omega*(d[30]*t1 + d[31]*t2 + d[32]*t3 + d[33]*t4 + d[34]*t5 + d[35]*t6);
    }
  }
}
