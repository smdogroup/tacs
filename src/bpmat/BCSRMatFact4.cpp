...
void BCSRMatFactor4( BCSRMatData * data ){
  ...
  for ( int i = 0; i < nrows; i++ ){
    // variable = i
    if ( diag[i] < 0 ){
      fprintf(stderr, "Error in factorization: no diagonal entry for \
row %d \n", i);
      return;
    }
    ...
    for ( int j = rowp[i]; cols[j] < i; j++ ){
      ...
      a = &A[16*j];
      a[0] = d00; a[1] = d01; a[2] = d02; a[3] = d03;
      a[4] = d10; a[5] = d11; a[6] = d12; a[7] = d13;
      a[8] = d20; a[9] = d21; a[10] = d22; a[11] = d23;
      a[12] = d30; a[13] = d31; a[14] = d32; a[15] = d33;
    }
    ...
    if ( info > 0 ){
      fprintf(stderr, "Error during factorization of diagonal block %d \
in row %d \n", i+1, info);
    }
  }
}
