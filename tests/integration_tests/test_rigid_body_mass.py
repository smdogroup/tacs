...
FUNC_REFS = {'rigid_body_Ixx': 760.2857142857142, 'rigid_body_Ixy': 10.5,               'rigid_body_Ixz': -210.5,
                                                  'rigid_body_Iyy': 478.14285714285717, 'rigid_body_Iyz': 72.85714285714286,
                                                                                        'rigid_body_Izz': 543.1428571428571,
             'rigid_body_cgx': 3.0, 'rigid_body_cgy': -1.1428571428571428, 'rigid_body_cgz': 3.857142857142857,
...
class ProblemTest(PyTACSTestCase.PyTACSTest):
    ...
    def setup_funcs(self, fea_assembler, problems):
        ...
        for problem in problems:
            ...
            problem.addFunction('Ixy', functions.MomentOfInertia, direction1=[0.0, 1.0, 0.0],
                                direction2=[1.0, 0.0, 0.0], aboutCM=True)
            problem.addFunction('Ixz', functions.MomentOfInertia, direction1=[0.0, 0.0, 1.0],
                                direction2=[1.0, 0.0, 0.0], aboutCM=True)
        ...
        func_list = ['mass', 'cgx', 'cgy', 'cgz', 'Ixx', 'Ixy', 'Ixz', 'Iyy', 'Iyz', 'Izz']
