...
class ProblemTest(TransientTestCase.TransientTest):
    ...
    def setup_tacs_vecs(self, assembler, force_history, dv_pert_vec, xpts_pert_vec):
        ...
        init_force = force_history[1]
        f_array = init_force.getArray().reshape(local_num_nodes, vars_per_node)

        # Apply impulse forces at tip of beam
        f_array[local_x == Lx, 2] = delta_fz
