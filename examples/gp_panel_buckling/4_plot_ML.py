...
plt.figure("axial")
for igamma, gamma in enumerate([0.0, 0.5, 1.0, 3.0, 10.0]):
    ...
    plt.plot(rho0_vec, N11cr_vec, label="axial" + str(igamma))
    # plt.plot(rho0_vec, N12cr_vec, label="shear"+str(igamma))
...
plt.legend()
plt.savefig("4-axial-ML.png", dpi=400)
plt.close("axial")
...
plt.legend()
plt.savefig("4-shear-ML.png", dpi=400)
