...
void createMaterialProperties( TACSMaterialProperties **props ){
  ...
  *props = new TACSMaterialProperties(rho, specific_heat, E, nu, ys, alpha, kappa);
}

/*
  Create a plane stress stiffness object with default properties
*/
void createPlaneStressElement( TACSMaterialProperties *props,
                               int order, int num, TACSElement **elem ){
...
*/
void testSolve( TACSAssembler *assembler,
                int noptions, const char *opts[] ){
  int rank, size;
