...
kGAy_A   = 16.88e6
kGAz_A   = 16.88e6
stiffA = constitutive.TimoshenkoConstitutive(rhoA_A, rhoIy_A, rhoIz_A, rhoIyz_A,
                                             EA_A, GJ_A, EIy_A, EIz_A, kGAy_A, kGAz_A,
                                             axis_A)
stiffB = constitutive.TimoshenkoConstitutive(rhoA_A, rhoIy_A, rhoIz_A, rhoIyz_A,
                                             EA_A, GJ_A, EIy_A, EIz_A, kGAy_A, kGAz_A,
                                             axis_B)
rhoA_B   = 0.4992
rhoIy_B  = 2.662e-6
...
kGAy_B   = 4.220e6
kGAz_B   = 4.220e6
stiffC = constitutive.TimoshenkoConstitutive(rhoA_B, rhoIy_B, rhoIz_B, rhoIyz_B,
                                             EA_B, GJ_B, EIy_B, EIz_B, kGAy_B, kGAz_B,
                                             axis_C)
